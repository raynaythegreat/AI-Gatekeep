  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center justify-between gap-2 w-full md:w-72 px-3 py-2 rounded-lg border border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-900 hover:bg-white dark:hover:bg-surface-800 hover:border-blue-500/50 transition-all shadow-sm group"
      >
        <div className="flex items-center gap-2 min-w-0">
          <svg className="w-5 h-5 text-surface-400 group-hover:text-blue-500 transition-colors flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          {showCreateForm ? (
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-surface-600 dark:text-surface-400 mb-1.5">
                   ...
                   <input
                     ...
                     className="w-full px-3 py-2 text-sm rounded-lg border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-800 text-surface-900 dark:text-surface-100 placeholder-surface-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500"
                     autoFocus
                   />
                </div>
                 ...
                 <div className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-surface-800 border border-surface-200 dark:border-surface-700">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      isPrivate ? "bg-blue-500" : "bg-surface-300 dark:bg-surface-600"
                    }`}
                  >
                    <span
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 text-sm font-medium rounded-lg bg-blue-500 text-white hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 shadow-sm"
                  >
                    {creating ? (
                      <>
            ...
            <>
              ...
              <button
                ...
                className="w-full px-4 py-3 flex items-center gap-3 text-left hover:bg-blue-50 dark:hover:bg-blue-900/10 border-b border-surface-200 dark:border-surface-700 transition-colors group"
              >
                ...
                <div>
                  <div className="text-sm font-medium text-blue-600 dark:text-blue-400">Create New Repository</div>
              ...
              <div className="p-2 border-b border-surface-700">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm rounded-lg border border-surface-700 dark:bg-surface-800 bg-white text-foreground placeholder-surface-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
              </div>
